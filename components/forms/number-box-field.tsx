...
type ExtendedProps = FormExtendedProps & { numberBoxOptions?: INumberBoxOptions }

type NumberBoxFieldProps<
...
export default function NumberBoxField<T extends FieldValues>({
  control,
  name,
  label,
  placeholder,
        ...
        return (
          <FormItem {...extendedProps?.formItem}>
            ...
            <NumberBox
              ...
              showClearButton
              {...extendedProps?.numberBoxOptions}
            />

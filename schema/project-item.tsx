...
export const projectItemFormSchema = z
  .object({
    ...
    stockIn: z.coerce.number(),
    stockOut: z.coerce.number(),
...
export const deleteProjectItemsFormSchema = z.object({
  codes: z.array(z.coerce.number()).default([]),
  isPermanent: z.boolean().optional(),
  projectCode: z.number(),
})

export const restoreProjectItemsFormSchema = z.object({
  codes: z.array(z.coerce.number()).default([]),
  projectCode: z.number(),
})

export type DeleteProjectItemsForm = z.infer<typeof deleteProjectItemsFormSchema>
export type RestoreProjectItemsForm = z.infer<typeof restoreProjectItemsFormSchema>

...
type ProjectIndividualBatchViewProps = {
  data: Awaited<ReturnType<typeof getBatchesMasterByProjectCode>>[number]
  onClose: () => void
}

export default function ProjectIndividualBatchView({ data, onClose }: ProjectIndividualBatchViewProps) {

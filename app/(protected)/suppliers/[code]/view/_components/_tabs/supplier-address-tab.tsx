...
export default function SupplierAddressTab({ addresses }: SupplierAddressTabProps) {
  const DATAGRID_STORAGE_KEY = 'dx-datagrid-supplier-address'
  const DATAGRID_UNIQUE_KEY = 'supplier-addresses'

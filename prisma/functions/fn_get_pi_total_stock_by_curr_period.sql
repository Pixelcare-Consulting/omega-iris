--* Get sum of total stock per project individual by current period
CREATE OR REPLACE FUNCTION fn_get_pi_total_stock_by_curr_period(
...
SELECT * FROM fn_get_pi_total_stock_by_curr_period();
SELECT * FROM fn_get_pi_total_stock_by_curr_period('month');
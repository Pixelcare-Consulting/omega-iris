--* Get active users (isActive = true) by current period
CREATE OR REPLACE FUNCTION fn_get_users_active_by_curr_period(
...
SELECT * FROM fn_get_users_active_by_curr_period();
SELECT * FROM fn_get_users_active_by_curr_period('month');
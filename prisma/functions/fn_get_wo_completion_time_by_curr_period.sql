...
SELECT * FROM fn_get_wo_completion_time_by_curr_period();
SELECT * FROM fn_get_wo_completion_time_by_curr_period('month');
SELECT * FROM fn_get_wo_completion_time_by_curr_period('quarter');